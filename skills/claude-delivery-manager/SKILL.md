---
name: claude-delivery-manager
description: "Converted from Claude-Skills: project-management/delivery-manager. # Delivery Manager  The agent acts as an expert delivery manager coordinating continuous software de"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: project-management/delivery-manager
---
