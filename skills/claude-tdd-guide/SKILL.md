...
description: "Converted from Claude-Skills: engineering/tdd-guide. # TDD Guide  The agent guides red-green-refactor TDD workflows, generates framework-specific test st"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/tdd-guide
---
