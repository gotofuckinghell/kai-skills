---
name: claude-sql-database-assistant
description: "Converted from Claude-Skills: engineering/sql-database-assistant. # SQL Database Assistant  > **Category:** Engineering > **Domain:** Database Development & Optimizat"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/sql-database-assistant
---
