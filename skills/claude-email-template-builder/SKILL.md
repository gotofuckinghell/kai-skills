---
name: claude-email-template-builder
description: "Converted from Claude-Skills: marketing/email-template-builder. # Email Template Builder  **Tier:** POWERFUL **Category:** Engineering / Marketing **Tags:** email t"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: marketing/email-template-builder
---
