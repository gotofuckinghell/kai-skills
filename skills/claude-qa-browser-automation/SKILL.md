---
name: claude-qa-browser-automation
description: "Converted from Claude-Skills: engineering/qa-browser-automation. # QA Browser Automation  The agent drives Chrome MCP for live browser testing and uses four Python t"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/qa-browser-automation
---
