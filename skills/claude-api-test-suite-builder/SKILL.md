---
name: claude-api-test-suite-builder
description: "Converted from Claude-Skills: engineering/api-test-suite-builder. # API Test Suite Builder  Scan API route definitions across frameworks (Next.js App Router, Express,"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/api-test-suite-builder
---
