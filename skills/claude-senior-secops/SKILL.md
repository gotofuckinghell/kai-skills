---
name: claude-senior-secops
description: "Converted from Claude-Skills: engineering/senior-secops. # Senior SecOps Engineer  The agent scans source code for security vulnerabilities (hardcoded secret"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/senior-secops
---
