---
name: claude-notion-pm
description: "Converted from Claude-Skills: project-management/notion-pm. # Notion for Product Management  Master-level expertise in using Notion as the documentation and ope"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: project-management/notion-pm
---
