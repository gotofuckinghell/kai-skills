---
name: claude-site-architecture
description: "Converted from Claude-Skills: marketing/site-architecture. # Site Architecture & Internal Linking  Production-grade website architecture framework covering URL"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: marketing/site-architecture
---
