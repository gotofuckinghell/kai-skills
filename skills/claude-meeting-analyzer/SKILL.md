...
description: "Converted from Claude-Skills: project-management/meeting-analyzer. # Meeting Analyzer  Meetings fail at the seam between talking and tracking. The decision gets made a"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: project-management/meeting-analyzer
---
