---
name: claude-legal-meeting-briefing
description: "Converted from Claude-Skills: legal/legal-meeting-briefing. > **⚠️ EXPERIMENTAL** — This skill is provided for educational and informational purposes only. It d"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: legal/legal-meeting-briefing
---
