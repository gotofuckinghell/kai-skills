---
name: claude-playwright-pro
description: "Converted from Claude-Skills: engineering/playwright-pro. # Playwright Pro  Production-grade end-to-end testing with Playwright. Generate tests from user stor"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/playwright-pro
---
