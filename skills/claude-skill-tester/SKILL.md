---
name: claude-skill-tester
description: "Converted from Claude-Skills: engineering/skill-tester. # Skill Tester  Validate skill packages for structure compliance, test Python scripts for syntax and"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/skill-tester
---
