---
name: claude-handoff
description: "Converted from Claude-Skills: workflow/handoff. # Handoff  ## Overview  A handoff is a self-contained context package that lets a different person —"
version: 1.0.0
...
metadata:
  hermes:
    tags: [workflow, claude-skills, converted]
    source: https://github.com/borghei/Claude-Skills
    source_path: workflow/handoff
---
