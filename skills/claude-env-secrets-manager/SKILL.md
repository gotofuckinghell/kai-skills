---
name: claude-env-secrets-manager
description: "Converted from Claude-Skills: engineering/env-secrets-manager. # Env & Secrets Manager  Complete environment variable and secrets management lifecycle: .env file s"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/env-secrets-manager
---
