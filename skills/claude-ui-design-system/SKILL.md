...
description: "Converted from Claude-Skills: product-team/ui-design-system. # UI Design System  Generate design tokens, create color palettes, calculate typography scales, buil"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: product-team/ui-design-system
---
