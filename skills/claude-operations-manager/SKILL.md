---
name: claude-operations-manager
description: "Converted from Claude-Skills: hr-operations/operations-manager. # Operations Manager  The agent operates as a senior operations manager, applying Lean Six Sigma, PD"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: hr-operations/operations-manager
---
