...
description: "Converted from Claude-Skills: engineering/write-a-skill. # Write A Skill  The meta-skill for building skill packages. It turns `standards/skill-authoring-sta"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/write-a-skill
---
