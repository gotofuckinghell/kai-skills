---
name: claude-ms365-tenant-manager
description: "Converted from Claude-Skills: engineering/ms365-tenant-manager. # Microsoft 365 Tenant Manager  The agent generates production-ready PowerShell scripts for M365 ten"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/ms365-tenant-manager
---
