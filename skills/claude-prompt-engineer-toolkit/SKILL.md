---
name: claude-prompt-engineer-toolkit
description: "Converted from Claude-Skills: engineering/prompt-engineer-toolkit. # Prompt Engineer Toolkit — Production Prompt Engineering  The complete lifecycle for production pro"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/prompt-engineer-toolkit
---
