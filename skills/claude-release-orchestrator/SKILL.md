...
description: "Converted from Claude-Skills: engineering/release-orchestrator. # Release Orchestrator  The agent runs pre-flight validation, generates changelogs from conventional"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/release-orchestrator
---
