---
name: claude-migration-architect
description: "Converted from Claude-Skills: engineering/migration-architect. # Migration Architect  Generates phased migration plans with risk assessment, compatibility analysis"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/migration-architect
---
