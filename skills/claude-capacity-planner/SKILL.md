---
name: claude-capacity-planner
description: "Converted from Claude-Skills: business-operations/capacity-planner. # Capacity Planner  Turns headcount into hours you can actually commit. Most capacity plans fail the"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: business-operations/capacity-planner
---
