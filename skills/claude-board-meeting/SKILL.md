---
name: claude-board-meeting
description: "Converted from Claude-Skills: c-level-advisor/board-meeting. # Board Meeting Protocol  Structured multi-agent deliberation that prevents groupthink, captures min"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: c-level-advisor/board-meeting
---
