---
name: claude-decision-logger
description: "Converted from Claude-Skills: c-level-advisor/decision-logger. # Decision Logger  Two-layer memory system for executive decisions. Layer 1 stores everything discus"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: c-level-advisor/decision-logger
---
