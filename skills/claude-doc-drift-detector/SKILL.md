---
name: claude-doc-drift-detector
description: "Converted from Claude-Skills: engineering/doc-drift-detector. # Documentation Drift Detector  The agent detects documentation drift by mapping code directories to"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/doc-drift-detector
---
