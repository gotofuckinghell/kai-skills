---
name: claude-helm-chart-builder
description: "Converted from Claude-Skills: engineering/helm-chart-builder. # Helm Chart Builder  > **Category:** Engineering > **Domain:** Kubernetes & Helm  ## Overview  The "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/helm-chart-builder
---
