---
name: claude-senior-cloud-architect
description: "Converted from Claude-Skills: engineering/senior-cloud-architect. # Senior Cloud Architect  Expert cloud architecture and infrastructure design across AWS, GCP, and A"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/senior-cloud-architect
---
