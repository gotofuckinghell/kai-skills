...
description: "Converted from Claude-Skills: legal/contract-review. > **⚠️ EXPERIMENTAL** — This skill is provided for educational and informational purposes only. It d"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: legal/contract-review
---
