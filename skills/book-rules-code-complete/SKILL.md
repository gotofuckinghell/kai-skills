---
name: book-rules-code-complete
description: "Coding agent rules distilled from 'code-complete'. Use when user invokes $book-rules-code-complete for refactoring, code review, or design work in this domain. Code Complete (S. McConnell) — disciplined construction: variables, control flow, defensive coding, standards, testing."
version: 1.0.0
author: ciembor (agent-rules-books) + Hermes port
license: MIT
platforms: [linux, macos, windows]
source: https://github.com/ciembor/agent-rules-books
source_file: code-complete/code-complete.md
metadata:
  hermes:
    tags: [book-rules, code-quality, refactoring, code-complete]
    homepage: https://github.com/ciembor/agent-rules-books
---

# Book Rules: Code Complete

Full rule set from the original **code-complete** by `ciembor/agent-rules-books`. This is the canonical `full` version (not `mini`, not `nano`) — all rules verbatim from the upstream source.

## When to use this skill

Load this skill with `$book-rules-code-complete` when:
