---
name: claude-clinical-research
description: "Converted from Claude-Skills: research-ops/clinical-research. # Clinical Research  Operational support for running clinical studies: structuring a protocol so it "
version: 1.0.0
...
metadata:
  hermes:
    tags: [research-ops, claude-skills, converted]
    source: https://github.com/borghei/Claude-Skills
    source_path: research-ops/clinical-research
---
