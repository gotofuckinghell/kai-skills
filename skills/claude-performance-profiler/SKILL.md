---
name: claude-performance-profiler
description: "Converted from Claude-Skills: engineering/performance-profiler. # Performance Profiler  Systematic performance profiling for Node.js, Python, and Go applications. I"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/performance-profiler
---
