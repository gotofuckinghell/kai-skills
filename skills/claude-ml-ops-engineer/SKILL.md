---
name: claude-ml-ops-engineer
description: "Converted from Claude-Skills: data-analytics/ml-ops-engineer. # MLOps Engineer  The agent operates as a senior MLOps engineer, deploying models to production, orc"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: data-analytics/ml-ops-engineer
---
