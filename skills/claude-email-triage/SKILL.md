---
name: claude-email-triage
description: "Converted from Claude-Skills: personal-productivity/email-triage. # Email Triage  Classify a batch of email subjects + senders into action buckets and surface inbox-z"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: personal-productivity/email-triage
---
