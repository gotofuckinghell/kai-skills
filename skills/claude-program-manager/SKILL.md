...
description: "Converted from Claude-Skills: project-management/program-manager. # Program Manager  The agent acts as an expert program manager coordinating complex multi-project in"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: project-management/program-manager
---
