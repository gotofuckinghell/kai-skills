...
description: "Converted from Claude-Skills: c-level-advisor/chief-of-staff. # Chief of Staff  The orchestration layer between founder and C-suite. Reads the question, scores co"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: c-level-advisor/chief-of-staff
---
