...
description: "Converted from Claude-Skills: engineering/code-reviewer. # Code Reviewer  Automated code review tooling that analyzes pull requests for complexity and risk, "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/code-reviewer
---
