---
name: claude-dpia-assessment
description: "Converted from Claude-Skills: legal/dpia-assessment. > **⚠️ EXPERIMENTAL** — This skill is provided for educational and informational purposes only. It d"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: legal/dpia-assessment
---
