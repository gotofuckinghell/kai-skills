---
name: claude-codex-cli-specialist
description: "Converted from Claude-Skills: engineering/codex-cli-specialist. # Codex CLI Specialist  The agent converts Claude Code skills to Codex-compatible format, validates "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/codex-cli-specialist
---
