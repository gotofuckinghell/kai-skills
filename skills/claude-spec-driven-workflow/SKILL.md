---
name: claude-spec-driven-workflow
description: "Converted from Claude-Skills: engineering/spec-driven-workflow. # Spec-Driven Workflow  Development where the specification is the source of truth and the code is i"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/spec-driven-workflow
---
