---
name: claude-customer-success-manager
description: "Converted from Claude-Skills: sales-success/customer-success-manager. # Customer Success Manager  The agent operates as an expert customer success manager, driving retent"
version: 1.0.0
...
metadata:
  hermes:
    tags: [sales-success, claude-skills, converted]
    source: https://github.com/borghei/Claude-Skills
    source_path: sales-success/customer-success-manager
---
