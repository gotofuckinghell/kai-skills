---
name: claude-kubernetes-operator
description: "Converted from Claude-Skills: engineering/kubernetes-operator. # Kubernetes Operator  End-to-end Kubernetes operator design and construction. Covers the operator p"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/kubernetes-operator
---
