---
name: book-rules-a-philosophy-of-software-design
description: "Coding agent rules distilled from 'a-philosophy-of-software-design'. Use when user invokes $book-rules-a-philosophy-of-software-design for refactoring, code review, or design work in this domain. Philosophy of Software Design (Ousterhout) — fights complexity via deep modules, simple interfaces, information hiding, low cognitive load."
version: 1.0.0
author: ciembor (agent-rules-books) + Hermes port
license: MIT
platforms: [linux, macos, windows]
source: https://github.com/ciembor/agent-rules-books
source_file: a-philosophy-of-software-design/a-philosophy-of-software-design.md
metadata:
  hermes:
    tags: [book-rules, code-quality, refactoring, a-philosophy-of-software-design]
    homepage: https://github.com/ciembor/agent-rules-books
---

# Book Rules: A Philosophy Of Software Design

Full rule set from the original **a-philosophy-of-software-design** by `ciembor/agent-rules-books`. This is the canonical `full` version (not `mini`, not `nano`) — all rules verbatim from the upstream source.

## When to use this skill

Load this skill with `$book-rules-a-philosophy-of-software-design` when:
