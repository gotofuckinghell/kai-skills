---
name: claude-cold-email
description: "Converted from Claude-Skills: marketing/cold-email. # Cold Email Outreach  Production-grade B2B cold email that sounds like it came from a person, not a"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: marketing/cold-email
---
