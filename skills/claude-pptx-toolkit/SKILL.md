---
name: claude-pptx-toolkit
description: "Converted from Claude-Skills: documents/pptx-toolkit. # Pptx Toolkit  Audit `.pptx` files using the standard library only — no `python-pptx` required. Rea"
version: 1.0.0
...
metadata:
  hermes:
    tags: [documents, claude-skills, converted]
    source: https://github.com/borghei/Claude-Skills
    source_path: documents/pptx-toolkit
---
