---
name: claude-senior-frontend
description: "Converted from Claude-Skills: engineering/senior-frontend. # Senior Frontend  Frontend development patterns, performance optimization, and automation tools for"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/senior-frontend
---
