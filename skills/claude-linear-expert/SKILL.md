---
name: claude-linear-expert
description: "Converted from Claude-Skills: project-management/linear-expert. # Linear Expert  Master-level expertise in Linear configuration, workflow design, GraphQL API master"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: project-management/linear-expert
---
