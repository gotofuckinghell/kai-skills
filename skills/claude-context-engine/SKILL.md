...
description: "Converted from Claude-Skills: engineering/context-engine. # Context Engine - AI Agent Context Management  Context Engine provides production-grade patterns fo"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/context-engine
---
