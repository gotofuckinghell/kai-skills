---
name: claude-agent-workflow-designer
description: "Converted from Claude-Skills: engineering/agent-workflow-designer. # Agent Workflow Designer  The agent designs multi-agent orchestration systems using five core patte"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/agent-workflow-designer
---
