---
name: claude-roadmap-communicator
description: "Converted from Claude-Skills: product-team/roadmap-communicator. # Roadmap Communicator  A skill focused on **communicating the roadmap** — different audiences need "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: product-team/roadmap-communicator
---
