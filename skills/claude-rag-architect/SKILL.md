---
name: claude-rag-architect
description: "Converted from Claude-Skills: engineering/rag-architect. # RAG Architect  The agent designs, implements, and optimizes production-grade RAG pipelines, from d"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/rag-architect
---
