---
name: claude-jira-expert
description: "Converted from Claude-Skills: project-management/jira-expert. # Atlassian Jira Expert  Master-level expertise in Jira configuration, project management, JQL, work"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: project-management/jira-expert
---
