---
name: claude-spec-to-repo
description: "Converted from Claude-Skills: product-team/spec-to-repo. # Spec to Repo  A delivery-focused skill that bridges product spec to repository work. Where PRD-wri"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: product-team/spec-to-repo
---
