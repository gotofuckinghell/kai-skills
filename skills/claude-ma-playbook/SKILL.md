---
name: claude-ma-playbook
description: "Converted from Claude-Skills: c-level-advisor/ma-playbook. # M&A Playbook  Frameworks for both sides of M&A: acquiring companies and being acquired. Every M&A "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: c-level-advisor/ma-playbook
---
