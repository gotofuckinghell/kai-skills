---
name: claude-git-worktree-manager
description: "Converted from Claude-Skills: engineering/git-worktree-manager. # Git Worktree Manager  Manage parallel development workflows using Git worktrees with deterministic"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/git-worktree-manager
---
