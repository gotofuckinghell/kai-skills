---
name: claude-atlassian-admin
description: "Converted from Claude-Skills: project-management/atlassian-admin. # Atlassian Administrator Expert  System administrator with deep expertise in Atlassian Cloud/Data C"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: project-management/atlassian-admin
---
