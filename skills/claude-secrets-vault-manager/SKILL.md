---
name: claude-secrets-vault-manager
description: "Converted from Claude-Skills: engineering/secrets-vault-manager. # Secrets Vault Manager  > **Category:** Engineering > **Domain:** Secrets Management & Security  ##"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/secrets-vault-manager
---
