---
name: claude-agenthub
description: "Converted from Claude-Skills: engineering/agenthub. # AgentHub - Multi-Agent DAG Orchestration  AgentHub provides patterns and tools for orchestrating m"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/agenthub
---
