---
name: claude-md-document
description: "Converted from Claude-Skills: markdown-html/md-document. # Markdown Document Publishing  Turn an authored markdown file into a single HTML document you can e"
version: 1.0.0
...
metadata:
  hermes:
    tags: [markdown-html, claude-skills, converted]
    source: https://github.com/borghei/Claude-Skills
    source_path: markdown-html/md-document
---
