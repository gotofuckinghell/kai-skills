---
name: claude-aws-solution-architect
description: "Converted from Claude-Skills: engineering/aws-solution-architect. # AWS Solution Architect  Design scalable, cost-effective AWS architectures for startups with infras"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/aws-solution-architect
---
