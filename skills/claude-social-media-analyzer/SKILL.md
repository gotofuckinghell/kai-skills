---
name: claude-social-media-analyzer
description: "Converted from Claude-Skills: marketing/social-media-analyzer. # Social Media Analyzer  Campaign performance analysis with engagement metrics, ROI calculations, an"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: marketing/social-media-analyzer
---
