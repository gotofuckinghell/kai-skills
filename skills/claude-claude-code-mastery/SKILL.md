---
name: claude-claude-code-mastery
description: "Converted from Claude-Skills: engineering/claude-code-mastery. # Claude Code Mastery  Expert skill for Claude Code CLI -- CLAUDE.md optimization, skill authoring, "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/claude-code-mastery
---
