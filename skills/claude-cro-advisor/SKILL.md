---
name: claude-cro-advisor
description: "Converted from Claude-Skills: c-level-advisor/cro-advisor. # CRO Advisor  Revenue frameworks for building predictable, scalable revenue engines -- from first r"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: c-level-advisor/cro-advisor
---
