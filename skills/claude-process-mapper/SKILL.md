---
name: claude-process-mapper
description: "Converted from Claude-Skills: business-operations/process-mapper. # Process Mapper  Turns "this takes forever and nobody knows why" into a measured map with a ranked "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: business-operations/process-mapper
---
