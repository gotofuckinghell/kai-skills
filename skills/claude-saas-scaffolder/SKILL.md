---
name: claude-saas-scaffolder
description: "Converted from Claude-Skills: engineering/saas-scaffolder. # SaaS Scaffolder  Generate a complete, production-ready SaaS application boilerplate including auth"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/saas-scaffolder
---
