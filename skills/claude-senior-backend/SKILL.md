---
name: claude-senior-backend
description: "Converted from Claude-Skills: engineering/senior-backend. # Senior Backend Engineer  Scaffold and review backend services: API design and OpenAPI-driven code "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/senior-backend
---
