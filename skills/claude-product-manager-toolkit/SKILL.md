---
name: claude-product-manager-toolkit
description: "Converted from Claude-Skills: product-team/product-manager-toolkit. # Product Manager Toolkit  Essential tools and frameworks for modern product management, from discov"
version: 1.0.0
...
metadata:
  hermes:
    tags: [product-team, claude-skills, converted]
    source: https://github.com/borghei/Claude-Skills
    source_path: product-team/product-manager-toolkit
---
