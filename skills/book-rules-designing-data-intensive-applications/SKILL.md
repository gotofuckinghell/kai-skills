---
name: book-rules-designing-data-intensive-applications
description: "Coding agent rules distilled from 'designing-data-intensive-applications'. Use when user invokes $book-rules-designing-data-intensive-applications for refactoring, code review, or design work in this domain. Designing Data-Intensive Applications (Kleppmann) — reliability, scalability, consistency, replication, partitioning, schema evolution."
version: 1.0.0
author: ciembor (agent-rules-books) + Hermes port
license: MIT
platforms: [linux, macos, windows]
source: https://github.com/ciembor/agent-rules-books
source_file: designing-data-intensive-applications/designing-data-intensive-applications.md
metadata:
  hermes:
    tags: [book-rules, code-quality, refactoring, designing-data-intensive-applications]
    homepage: https://github.com/ciembor/agent-rules-books
---

# Book Rules: Designing Data Intensive Applications

Full rule set from the original **designing-data-intensive-applications** by `ciembor/agent-rules-books`. This is the canonical `full` version (not `mini`, not `nano`) — all rules verbatim from the upstream source.

## When to use this skill

Load this skill with `$book-rules-designing-data-intensive-applications` when:
