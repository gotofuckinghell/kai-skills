...
description: "Converted from Claude-Skills: workflow/skill-router. # Skill Router  ## Overview  This library has hundreds of skills across sixteen domains. A user rare"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: workflow/skill-router
---
