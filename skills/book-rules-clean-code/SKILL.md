---
name: book-rules-clean-code
description: "Coding agent rules distilled from 'clean-code'. Use when user invokes $book-rules-clean-code for refactoring, code review, or design work in this domain. Clean Code (R.C. Martin) — readability, naming, small functions, single responsibility, tests, simplicity."
version: 1.0.0
author: ciembor (agent-rules-books) + Hermes port
license: MIT
platforms: [linux, macos, windows]
source: https://github.com/ciembor/agent-rules-books
source_file: clean-code/clean-code.md
metadata:
  hermes:
    tags: [book-rules, code-quality, refactoring, clean-code]
    homepage: https://github.com/ciembor/agent-rules-books
---

# Book Rules: Clean Code

Full rule set from the original **clean-code** by `ciembor/agent-rules-books`. This is the canonical `full` version (not `mini`, not `nano`) — all rules verbatim from the upstream source.

## When to use this skill

Load this skill with `$book-rules-clean-code` when:
