---
name: claude-self-improving-agent
description: "Converted from Claude-Skills: engineering/self-improving-agent. # Self-Improving Agent - Autonomous Learning Patterns  Architectural patterns for AI agents that get"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/self-improving-agent
---
