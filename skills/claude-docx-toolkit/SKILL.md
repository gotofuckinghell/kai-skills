---
name: claude-docx-toolkit
description: "Converted from Claude-Skills: documents/docx-toolkit. # Docx Toolkit  Audit `.docx` files using the standard library only — no `python-docx` required. Rea"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: documents/docx-toolkit
---
