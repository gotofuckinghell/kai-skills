---
name: claude-domain-name-brainstormer
description: "Converted from Claude-Skills: personal-productivity/domain-name-brainstormer. # Domain Name Brainstormer  Generate and score candidate brand / domain names from seed words using "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: personal-productivity/domain-name-brainstormer
---
