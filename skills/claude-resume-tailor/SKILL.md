...
description: "Converted from Claude-Skills: personal-productivity/resume-tailor. # Resume Tailor  Tailor a base resume to a specific job description with keyword-match scoring, gap "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: personal-productivity/resume-tailor
---
