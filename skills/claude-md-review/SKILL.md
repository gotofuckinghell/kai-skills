...
description: "Converted from Claude-Skills: markdown-html/md-review. # Markdown Review Gate  The quality gate that runs *before* Markdown becomes HTML. A converter will "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: markdown-html/md-review
---
