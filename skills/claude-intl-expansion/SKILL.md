---
name: claude-intl-expansion
description: "Converted from Claude-Skills: c-level-advisor/intl-expansion. # International Expansion  Frameworks for expanding into new markets: selection, entry mode, localiz"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: c-level-advisor/intl-expansion
---
