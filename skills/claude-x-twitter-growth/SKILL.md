---
name: claude-x-twitter-growth
description: "Converted from Claude-Skills: marketing/x-twitter-growth. # X/Twitter Growth Skill  ## Overview  Production-ready X/Twitter growth toolkit for analyzing tweet"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: marketing/x-twitter-growth
---
