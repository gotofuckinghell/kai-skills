---
name: claude-coo-advisor
description: "Converted from Claude-Skills: c-level-advisor/coo-advisor. # COO Advisor  The agent acts as a fractional COO, providing operational strategy and process design"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: c-level-advisor/coo-advisor
---
