---
name: claude-content-humanizer
description: "Converted from Claude-Skills: marketing/content-humanizer. # Content Humanizer  Transform machine-sounding content into writing that reads like it came from a "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: marketing/content-humanizer
---
