---
name: claude-content-production
description: "Converted from Claude-Skills: marketing/content-production. # Content Production  The execution engine for content — taking topics from blank page to published,"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: marketing/content-production
---
