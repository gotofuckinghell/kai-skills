---
name: claude-tech-contract-negotiation
description: "Converted from Claude-Skills: legal/tech-contract-negotiation. > **⚠️ EXPERIMENTAL** — This skill is provided for educational and informational purposes only. It d"
version: 1.0.0
...
metadata:
  hermes:
    tags: [legal, claude-skills, converted]
    source: https://github.com/borghei/Claude-Skills
    source_path: legal/tech-contract-negotiation
---
