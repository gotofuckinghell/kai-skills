---
name: claude-pdf-toolkit
description: "Converted from Claude-Skills: documents/pdf-toolkit. # PDF Toolkit  Audit `.pdf` files for metadata, page count, encryption status, embedded JavaScript, "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: documents/pdf-toolkit
---
