---
name: claude-capture
description: "Converted from Claude-Skills: personal-productivity/capture. # Capture  A reliable front door for every commitment, idea, and open loop — and a processing pass t"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: personal-productivity/capture
---
