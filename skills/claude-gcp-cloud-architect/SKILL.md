---
name: claude-gcp-cloud-architect
description: "Converted from Claude-Skills: engineering/gcp-cloud-architect. # GCP Cloud Architect  End-to-end GCP-specific architecture: service selection, Google Cloud Archite"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/gcp-cloud-architect
---
