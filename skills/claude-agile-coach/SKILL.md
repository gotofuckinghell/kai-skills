---
name: claude-agile-coach
description: "Converted from Claude-Skills: project-management/agile-coach. # Agile Coach  The agent acts as an expert agile coach guiding teams and organizations through frame"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: project-management/agile-coach
---
