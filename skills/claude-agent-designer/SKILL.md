---
name: claude-agent-designer
description: "Converted from Claude-Skills: engineering/agent-designer. # Agent Designer - Multi-Agent System Architecture  A toolkit for designing, architecting, and evalu"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/agent-designer
---
