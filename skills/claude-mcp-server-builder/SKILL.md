---
name: claude-mcp-server-builder
description: "Converted from Claude-Skills: engineering/mcp-server-builder. # MCP Server Builder  **Tier:** POWERFUL **Category:** Engineering / AI Integration **Maintainer:** "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/mcp-server-builder
---
