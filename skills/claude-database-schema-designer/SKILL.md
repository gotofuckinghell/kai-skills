---
name: claude-database-schema-designer
description: "Converted from Claude-Skills: engineering/database-schema-designer. # Database Schema Designer  Design normalized relational database schemas from requirements and gene"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/database-schema-designer
---
