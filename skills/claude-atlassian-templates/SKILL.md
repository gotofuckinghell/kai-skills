---
name: claude-atlassian-templates
description: "Converted from Claude-Skills: project-management/atlassian-templates. # Atlassian Template & Files Creator Expert  Specialist in creating, modifying, and managing reusabl"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: project-management/atlassian-templates
---
