---
name: claude-referral-program
description: "Converted from Claude-Skills: business-growth/referral-program. # Referral Program  Production-grade referral and affiliate program framework covering the 4-stage r"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: business-growth/referral-program
---
