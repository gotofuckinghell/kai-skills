---
name: claude-release-manager
description: "Converted from Claude-Skills: engineering/release-manager. # Release Manager  The agent automates release management by parsing conventional commits into struc"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/release-manager
---
