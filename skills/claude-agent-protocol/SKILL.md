---
name: claude-agent-protocol
description: "Converted from Claude-Skills: engineering/agent-protocol. # Agent Protocol  The agent designs tool schemas for MCP, Google A2A, and OpenAI Function Calling pr"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/agent-protocol
---
