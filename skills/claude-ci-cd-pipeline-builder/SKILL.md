---
name: claude-ci-cd-pipeline-builder
description: "Converted from Claude-Skills: engineering/ci-cd-pipeline-builder. # CI/CD Pipeline Builder  Generate production-grade CI/CD pipelines from detected project stack sign"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/ci-cd-pipeline-builder
---
