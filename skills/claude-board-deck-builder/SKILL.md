---
name: claude-board-deck-builder
description: "Converted from Claude-Skills: c-level-advisor/board-deck-builder. # Board Deck Builder  Build board decks that tell a story, not just show data. Every section has an "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: c-level-advisor/board-deck-builder
---
