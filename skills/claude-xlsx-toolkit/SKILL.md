---
name: claude-xlsx-toolkit
description: "Converted from Claude-Skills: documents/xlsx-toolkit. # Xlsx Toolkit  Audit `.xlsx` files using the standard library only — no `openpyxl` required. Reads "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: documents/xlsx-toolkit
---
