---
name: claude-product-analytics
description: "Converted from Claude-Skills: product-team/product-analytics. # Product Analytics  A product analytics skill focused on **decisions from data**, not dashboards. C"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: product-team/product-analytics
---
