...
description: "Converted from Claude-Skills: engineering/code-tour. # Code Tour  A guided path through a codebase, ordered so each stop makes the next one legible, and "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/code-tour
---
