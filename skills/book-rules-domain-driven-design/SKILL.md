---
name: book-rules-domain-driven-design
description: "Coding agent rules distilled from 'domain-driven-design'. Use when user invokes $book-rules-domain-driven-design for refactoring, code review, or design work in this domain. Domain-Driven Design (E. Evans) — ubiquitous language, bounded contexts, tactical + strategic patterns."
version: 1.0.0
author: ciembor (agent-rules-books) + Hermes port
license: MIT
platforms: [linux, macos, windows]
source: https://github.com/ciembor/agent-rules-books
source_file: domain-driven-design/domain-driven-design.md
metadata:
  hermes:
    tags: [book-rules, code-quality, refactoring, domain-driven-design]
    homepage: https://github.com/ciembor/agent-rules-books
---

# Book Rules: Domain Driven Design

Full rule set from the original **domain-driven-design** by `ciembor/agent-rules-books`. This is the canonical `full` version (not `mini`, not `nano`) — all rules verbatim from the upstream source.

## When to use this skill

Load this skill with `$book-rules-domain-driven-design` when:
