...
description: "Converted from Claude-Skills: engineering/agent-harness. # Agent Harness  Most agents ship on vibes: someone tries eight prompts, the output looks good, it g"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/agent-harness
---
