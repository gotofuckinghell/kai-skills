---
name: claude-email-sequence
description: "Converted from Claude-Skills: marketing/email-sequence. # Email Sequence Design  **Category:** Marketing **Tags:** email sequences, drip campaigns, nurture "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: marketing/email-sequence
---
