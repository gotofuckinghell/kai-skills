---
name: claude-database-designer
description: "Converted from Claude-Skills: engineering/database-designer. # Database Designer  The agent analyzes SQL schemas for normalization compliance, recommends optimal"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: engineering/database-designer
---
