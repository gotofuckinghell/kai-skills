---
name: claude-productboard-expert
description: "Converted from Claude-Skills: project-management/productboard-expert. # Productboard Expert  Master-level expertise in Productboard workspace configuration, Insight inbox"
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: project-management/productboard-expert
---
