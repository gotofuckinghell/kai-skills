---
name: claude-vendor-management
description: "Converted from Claude-Skills: business-operations/vendor-management. # Vendor Management  Covers the vendor lifecycle from selection to exit. Two failures dominate this "
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_path: business-operations/vendor-management
---
